...
if (isset($_POST)) {
    ...
    try {
      //  $mail->SMTPDebug = 2;  // 0,1,2: chế độ debug. khi mọi cấu hình đều tớt thì chỉnh lại 0 nhé
        ...
        $nguoigui = 'khoadn.22it@vku.udn.vn';//email người gửi
        $matkhau = 'irgy vywe mhxb nzdl';//matkhau
        $tennguoigui = 'Do Ngoc Khoa';//ten nguoi gui
        ...
        $act = 2;
        if($act == 1){
            $to_name = isset($_POST['nameperson']) ? $_POST['nameperson'] : "bạn";
            $to = $_POST['email'];
